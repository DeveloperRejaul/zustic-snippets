...
import { FlatList, Image, View, useWindowDimensions, type NativeSyntheticEvent, type NativeScrollEvent, type ViewStyle, Pressable } from 'react-native';
...
export default forwardRef((props: ICardCarousal, ref) => {
  ...
  // handle key
  const keyExtractor = (item:IData, index:number) => item?.id?.toString() || index.toString();
